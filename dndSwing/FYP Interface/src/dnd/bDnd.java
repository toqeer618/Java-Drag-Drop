...
/*
 * bDnd.java requires no other files.
 */
...
public class bDnd extends JPanel implements ActionListener {
    ...
    private static void createAndShowGUI() {
        ...
        frame = new JFrame("bDnd");
        frame.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
 
        //Create and set up the content pane.
        JComponent newContentPane = new bDnd();
