...
public class LabelDragger implements ActionListener {
	private static JTextField textField;
    public static void main(final String[] args) {
        final int labelRows = 1,    //How many rows of labels.
                  labelColumns = 5, //How many columns of labels.
                  labelWidth = 55,  //Width for each label.
                  labelHeight = 100; //Height for each label.
        ...
        final JFrame frame = new JFrame("hshsh");
       ...
       textField = new JTextField();
        textField.setBounds(316, 11, 86, 20);
